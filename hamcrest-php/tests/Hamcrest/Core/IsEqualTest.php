...
class Hamcrest_DummyToStringClass
{
  private $_arg;
...
class Hamcrest_Core_IsEqualTest extends Hamcrest_AbstractMatcherTest
{
  ...
  public function testIncludesTheResultOfCallingToStringOnItsArgumentInTheDescription()
  {
    ...
    $argument = new Hamcrest_DummyToStringClass($argumentDescription);
