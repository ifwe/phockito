...
class PhockitoTest_FooHasVoidReturnType { function Foo() : void { } }
class PhockitoTest_FooHasNullableBoolReturnType { function Foo() : ?bool { return true; } }
class PhockitoTest_FooHasNullableObjectReturnType { function Foo() : ?stdClass { return new stdClass(); } }
class PhockitoTest_FooHasBoolReturnType { function Foo() : bool { return true; } }
class PhockitoTest_FooHasIntReturnType { function Foo() : int { return 2; } }
class PhockitoTest_FooHasFloatReturnType { function Foo() : float { return 2; } }
class PhockitoTest_FooHasStringReturnType { function Foo() : string { return 'unmocked string'; } }
class PhockitoTest_FooHasStdClassReturnType { function Foo() : stdClass { return new stdClass(); } }
...
class PhockitoTest extends \PHPUnit\Framework\TestCase {
    ...
    function testCanCreateMockMethodVoidReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasVoidReturnType');
        $this->assertNull($mock->Foo());
    }

    function testCanCreateMockMethodNullableBoolReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasNullableBoolReturnType');
        $this->assertNull($mock->Foo());
    }

    function testCanCreateMockMethodNullableObjectReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasNullableObjectReturnType');
        $this->assertNull($mock->Foo());
    }

    function testCanCreateMockMethodBoolReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasBoolReturnType');
        $this->assertFalse($mock->Foo());
    }

    function testCanCreateMockMethodIntReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasIntReturnType');
        $this->assertSame(0, $mock->Foo());
    }

    function testCanCreateMockMethodFloatReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasFloatReturnType');
        $this->assertSame(0.0, $mock->Foo());
    }

    function testCanCreateMockMethodStringReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasStringReturnType');
        $this->assertSame('', $mock->Foo());
    }

    function testCanCreateMockMethodStdClassReturnType() {
        $mock = Phockito::mock('PhockitoTest_FooHasStdClassReturnType');
        try {
            $mock->Foo();
            $this->fail('should throw');
        } catch (TypeError $e) {
            $this->assertContains('must be an instance of stdClass', $e->getMessage(), 'php throws when attempting to return null');
        }
    }
